# =========================================================
#  HOUMI STUDIO - POWERSHELL ONLINE PATCH PUBLISHER v0.4.3
# =========================================================
...
Write-Host "  HOUMI STUDIO - PUBLISH ONLINE PATCH v0.4.3 Release" -ForegroundColor Yellow
Write-Host "==================================================" -ForegroundColor Yellow
...
# 3. Create update manifest for v0.4.3
$manifest = [ordered]@{
    latest_version   = "0.4.3"
    patch_notes      = "v0.4.3 Release - Automated Photoshop Project Batch Launch (ImageTrans JSX), Korean PP-OCRv5 Default, Whole Project Pipeline Scope"
...
Write-Host "✅ [PowerShell] Updated manifest files to v0.4.3!" -ForegroundColor Green

# 4. Notify dev_patch_service in backend
Push-Location "E:\houmi\backend"
.venv\Scripts\python.exe -c "import sys; sys.path.insert(0, '.'); from app.services.dev_patch_service import record_dev_patch; record_dev_patch({'is_customer_release': True, 'customer_version': '0.4.3', 'changes': [{'category': 'Added', 'description': 'Automated Photoshop Project Batch Launch (ImageTrans JSX)'}, {'category': 'Changed', 'description': 'Set default OCR model to PP-OCRv5 Korean (ko) and Pipeline Scope to Whole Project'}]})"
Pop-Location

Write-Host "🚀 Patch v0.4.3 published successfully!" -ForegroundColor Green
