# =========================================================
#  HOUMI STUDIO - POWERSHELL ONLINE PATCH PUBLISHER v0.4.4
# =========================================================
...
Write-Host "  HOUMI STUDIO - PUBLISH ONLINE PATCH v0.4.4 Release" -ForegroundColor Yellow
Write-Host "==================================================" -ForegroundColor Yellow
...
# 3. Create update manifest for v0.4.4
$manifest = [ordered]@{
    latest_version   = "0.4.4"
    patch_notes      = "v0.4.4 Release - Faux Style Resolution, Photoshop Auto Leading Parity & UI Font Presets"
...
Write-Host "✅ [PowerShell] Updated manifest files to v0.4.4!" -ForegroundColor Green

# 4. Notify dev_patch_service in backend
Push-Location "E:\houmi\backend"
.venv\Scripts\python.exe -c "import sys; sys.path.insert(0, '.'); from app.services.dev_patch_service import record_dev_patch; record_dev_patch({'is_customer_release': True, 'customer_version': '0.4.4', 'changes': [{'category': 'Fixed', 'description': 'TF Phethai faux italic style resolution and template font style mapping'}, {'category': 'Added', 'description': 'Photoshop Auto Leading default parity (1.20 / 120%)'}, {'category': 'Changed', 'description': 'Case-insensitive font style selection and normalized dropdown values'}]})"
Pop-Location

Write-Host "🚀 Patch v0.4.4 published successfully!" -ForegroundColor Green
