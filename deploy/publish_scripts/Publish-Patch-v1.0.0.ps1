# =========================================================
#  HOUMI STUDIO - POWERSHELL ONLINE PATCH PUBLISHER v1.0.0
# =========================================================
...
Write-Host "  HOUMI STUDIO - PUBLISH ONLINE PATCH v1.0.0 Release" -ForegroundColor Yellow
Write-Host "==================================================" -ForegroundColor Yellow
...
# 3. Create update manifest for v1.0.0
$manifest = [ordered]@{
    latest_version   = "1.0.0"
    patch_notes      = "v1.0.0 Official Release - SOTA Manga/Webtoon Translation, Smart Balloon, Magnetic Inpainting & Photoshop Production Suite"
...
Write-Host "✅ [PowerShell] Updated manifest files to v1.0.0!" -ForegroundColor Green

# 4. Notify dev_patch_service in backend
Push-Location "E:\houmi\backend"
.venv\Scripts\python.exe -c "import sys; sys.path.insert(0, '.'); from app.services.dev_patch_service import record_dev_patch; record_dev_patch({'is_customer_release': True, 'customer_version': '1.0.0', 'changes': [{'category': 'Added', 'description': 'Magnetic Line Mask (Zero Gap), 56px Kernel, Smart Phonetic Font Aliasing & Rescan, SOTA AnimeMangaInpainting, Smart Balloon Boundary Clamping'}]})"
Pop-Location

Write-Host "🚀 Patch v1.0.0 published locally and manifests updated successfully!" -ForegroundColor Green
