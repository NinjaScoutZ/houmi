# =========================================================
#  HOUMI STUDIO - POWERSHELL ONLINE PATCH PUBLISHER v0.4.0
# =========================================================
...
Write-Host "  HOUMI STUDIO - PUBLISH ONLINE PATCH v0.4.0 Early" -ForegroundColor Yellow
Write-Host "==================================================" -ForegroundColor Yellow
...
$manifest = [ordered]@{
    ...
    patch_notes      = "v0.4.0 Early Official Release - Photoshop Anti-Aliasing, Layer Stroke & Outline presets, Text Engine Mode selector, Smart Balloon Auto-Resize & Performance enhancements"
...
Write-Host "✅ [PowerShell] Updated local manifest $manifestPath to v0.4.0!" -ForegroundColor Green
...
Write-Host "`n🚀 [SUCCESS] Patch v0.4.0 Early is active and ready for online client updates!" -ForegroundColor Green
