...
import { 
  ...
  Pipette, Wand2, Minus, Plus, Clipboard, Scissors, ArrowUpDown, Crosshair
} from 'lucide-react';
...
export const App: React.FC = () => {
  ...
  const [settingsEnableSmartBalloon, setSettingsEnableSmartBalloon] = useState(() => getStoredSetting('enable_smart_balloon', true));
  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-[#09090b] text-slate-100 overflow-hidden font-sans relative">
      ...
      >
        ...
        {/* Right side Project selection & info */}
        <div className="flex items-center gap-3 pywebview-no-drag window-no-drag-region" style={{ WebkitAppRegion: 'no-drag' } as any}>
          <input 
            type="file" 
            multiple 
            accept="image/*" 
          ...
          {activeProject && (
            <div className="flex items-center gap-2">
              ...
              <button
                type="button"
                onClick={() => { setDevStudioInitialTab('dev_map'); setShowDevStudioModal(true); }}
                className="flex items-center gap-1 px-2 py-1 rounded bg-zinc-900 border border-zinc-800 text-slate-300 hover:text-amber-400 hover:border-amber-500/40 text-[10px] font-pixel font-bold uppercase tracking-wider transition-colors cursor-pointer"
                title="เปิดแผนผังโหนดการพัฒนา & Dev Changelog"
              >
              ...
              <button
                type="button"
                onClick={() => { setDevStudioInitialTab('dev_notes'); setShowDevStudioModal(true); }}
                className="flex items-center gap-1 px-2 py-1 rounded bg-zinc-900 border border-zinc-800 text-slate-300 hover:text-amber-400 hover:border-amber-500/40 text-[10px] font-pixel font-bold uppercase tracking-wider transition-colors cursor-pointer"
                title="เปิดหน้าจัดการ Developer Notes"
              >
              ...
              <button
                ...
                className="p-1 rounded bg-zinc-900 border border-zinc-800 text-slate-400 hover:text-amber-400 transition-colors cursor-pointer"
