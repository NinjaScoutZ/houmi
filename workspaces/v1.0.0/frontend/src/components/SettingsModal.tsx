              ...
              <div className="space-y-4 bg-zinc-900/30 p-4 rounded-lg border border-zinc-900">
                ...
                <div className="space-y-3">
                  ...
                  <div className="p-3.5 rounded-lg bg-gradient-to-b from-amber-500/15 to-amber-950/20 border border-amber-500/40 space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="px-2 py-0.2 bg-amber-400/20 text-amber-300 border border-amber-400/30 rounded text-[9.5px] font-pixel font-bold">
                            NEW V15
                          </span>
                        </div>
                      ...
                      <input
                        type="checkbox"
                        checked={Boolean(settings.enable_smart_balloon ?? true)}
                    ...
                    {Boolean(settings.enable_smart_balloon ?? true) && (
